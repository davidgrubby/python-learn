...
url_list = 'http://www.dianping.com/shanghai/ch10/g110p2?aid=93077944%2C97435241%2C98281287%2C110269910&cpt=93077944' \
           '%2C97435241%2C98281287%2C110269910'
...
content = soup.find('div', attrs={'class': 'shop-list J_shop-list shop-all-list'})
print(content)
